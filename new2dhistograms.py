...
hist1 = ax[0,0].hist(agn_data['zpdf'],binsx,histtype='step',color='r',label='AGNs (x100)',weights=zrescale)
hist2 = ax[0,0].hist(nonagn_useful['zpdf'],binsx,histtype='step',color='b',label='non AGNs')
ax[0,0].set_xlim(xlim)
ax[0,0].set_xticks([])
ax[0,0].set_yticks([])

ax[1,1].hist(agn_data['mass_best'],binsy,histtype='step',color='r',orientation='horizontal',weights=mrescale)
ax[1,1].hist(nonagn_useful['mass_best'],binsy,histtype='step',color='b',orientation='horizontal')
